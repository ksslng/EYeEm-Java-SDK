...
public class ParserTest extends EyeEmAbstractTest {
	EyeemConnect connect;
	@Before
	public void setUp() throws Exception {
		super.setUp();
		connect = new EyeemConnect();
	...
	public void testUsers(){
		...
		try {
			in = connect.getAssets().open("users.txt");
	...
	public void testPhoto(){
		...
		try {
			in = connect.getAssets().open("photo.txt");
	...
	public void testComment(){
		...
		try {
			in = connect.getAssets().open("comment.txt");
	...
	public void testNews(){
		...
		try {
			in = connect.getAssets().open("news.txt");
